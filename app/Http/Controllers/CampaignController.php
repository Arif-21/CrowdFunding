...
class CampaignController extends Controller
{
    ...
    {
        $campaigns = Campaign::select('*')->inRandomOrder()
                                          ->limit($count)
                                          ->get();
        ...
        return response()->json([
            'response_code' => '00',
            'response_message' => 'Berhasil menampilkan data campaigns',
            'data' => $data
        ], 200);
    }
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('image'))
        {
            ...
            try {
                ...
                return response()->json([
                    'response_code' => '01',
                    'response_message' => 'Gambar gagal di upload',
                ]);
            }
        }
    ...
    public function search($keyword)
    {
        ...
        return response()->json([
            'response_code' => '00',
            'response_message' => 'Campaigns berhasil di search',
            'data' => $data
        ], 200);        
    }
}
